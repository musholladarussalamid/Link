      ...
      <div className="p-4">
        {dataShareLink.map((item: link, index: number) => {
          ...
          if (item.label == "WhatsApp") {
            shareLink =
              "https://wa.me/?text=" + linkContent?.lable + " - " + urlShare;
          }
          if (item.label == "Facebook") {
            shareLink = "https://www.facebook.com/sharer.php?u=" + urlShare;
          }
          if (item.label == "Email") {
            shareLink =
        ...
        <div className="flex relative mt-2">
          ...
          />
          <button
            onClick={() => copylink(urlShare ? urlShare : "#")}
            type="submit"
...
export default ModalShareProgram;
